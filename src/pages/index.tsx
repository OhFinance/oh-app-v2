        ...
        <div className={`p-6 flex-col w-full h-full`}>
          <div className={`w-full h-full flex flex-row`}>
            <div className={`h-auto container flex flex-col justify-between h-auto`}>
              <div
                className={`h-auto flex flex-col rounded-lg border-2 border-consoleBorderInner bg-consoleBGInner`}
              >
                <div className={`h-full m-2 flex flex-col rounded-lg`}>
                  <div
              ...
              <div
                className={`h-64 flex flex-row rounded-lg border-2 border-consoleBorderInner bg-consoleBGInner`}
              >
                <div className={`w-full h-auto flex flex-col rounded-lg bg-consoleBGInner`}>
                  <div className={`h-full m-2 flex flex-col rounded-lg bg-consoleBGInner`}>
                    <div
                      className={`w-full h-full flex flex-col rounded-lg border-2 border-consoleBorderAccent bg-consoleAccent`}
                    >
                      <div className={`w-full h-full flex flex-row`}>
